// spg.c
// Stateless Flooding + Planar Geocasting (SF+SPG) Module with Dijkstra and Connected
// Dominating Set
// James Robinson
// 12/11/2016
...
model_t model = 
{
    "Stateless Flooding and Planar Geocasting with BFS and CDS",
    "Jordan Adamek",
    "0.1",
    MODELTYPE_ROUTING,
    {NULL, 0}
...
void tx(call_t *call, packet_t *packet)
{
    ...
    else if(header->sender.id == NONE){
	fprintf(stderr, "[RTG] Face routing packet for the first time at %d\n", call->node);
